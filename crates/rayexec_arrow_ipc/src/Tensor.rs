...
impl<'a> Tensor<'a> {
    ...
    #[inline]
    #[allow(non_snake_case)]
    pub fn type__as_run_end_encoded(&self) -> Option<RunEndEncoded<'a>> {
    ...
    #[inline]
    #[allow(non_snake_case)]
    pub fn type__as_binary_view(&self) -> Option<BinaryView<'a>> {
    ...
    #[inline]
    #[allow(non_snake_case)]
    pub fn type__as_utf_8_view(&self) -> Option<Utf8View<'a>> {
    ...
    #[inline]
    #[allow(non_snake_case)]
    pub fn type__as_list_view(&self) -> Option<ListView<'a>> {
    ...
    #[inline]
    #[allow(non_snake_case)]
    pub fn type__as_large_list_view(&self) -> Option<LargeListView<'a>> {
...
impl core::fmt::Debug for Tensor<'_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        match self.type_type() {
            ...
            Type::RunEndEncoded => {
                if let Some(x) = self.type__as_run_end_encoded() {
                    ds.field("type_", &x)
                } else {
                    ds.field(
                        "type_",
            ...
            Type::BinaryView => {
                if let Some(x) = self.type__as_binary_view() {
                    ds.field("type_", &x)
                } else {
                    ds.field(
                        "type_",
            ...
            Type::Utf8View => {
                if let Some(x) = self.type__as_utf_8_view() {
                    ds.field("type_", &x)
                } else {
                    ds.field(
                        "type_",
            ...
            Type::ListView => {
                if let Some(x) = self.type__as_list_view() {
                    ds.field("type_", &x)
                } else {
                    ds.field(
                        "type_",
            ...
            Type::LargeListView => {
                if let Some(x) = self.type__as_large_list_view() {
                    ds.field("type_", &x)
                } else {
                    ds.field(
                        "type_",
